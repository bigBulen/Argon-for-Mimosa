...
<!--  
     注意：
	 侧边栏的作者卡片是会自动吸附的，且只会随着id为leftbar_part1的卡片吸附。
	 因此，如果你想要在侧边栏中添加其他卡片，请确保它们的id不是leftbar_part1。
	 （也就是说，作者卡片上方的卡片必须是leftbar_part1，且只能有一个）
...
<aside id="leftbar" class="leftbar widget-area" role="complementary">
		...
		<?php } ?>
		<!--  侧边栏2-目录 -->
		<div id="leftbar_announcement" class="widget widget_search card bg-white shadow-sm border-0">
		...
		?>
		<div id="leftbar_part1" class="widget widget_search card bg-white shadow-sm border-0 p-3 mb-4">
			<?php
		global $todayData,
			$birthday_name_cn, $birthday_name_jp,
			$birthday_quote, $birthday_description,
			$custom_bg_url, $suffix;

		if ( $todayData ) : ?>
			<!-- 生日庆祝卡片 -->
			<div class="happy_birthday_card" style="font-weight: bold; color: #ffd700; text-align: left; font-size: 1.15rem; margin-bottom: 8px;">
				<!-- 可选标题占位 -->
			</div>
			...
			<div class="text-center">
				...
				<?php echo esc_html( $birthday_name_cn . $suffix ); ?>
				</div>
